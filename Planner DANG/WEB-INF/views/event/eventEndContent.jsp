...
function prizeList(){
   ...
   window.open('eventPrizeList.pd?fullName='+document.all.fullName.value,'list','width=350, height=400, left='+popupX+', top='+popupY+', screenX='+popupX+', screenY='+popupY);
}
</script>
</head>
<body>
...
<div id="container">
<div class="button-4" style="margin-left: 140px;">
    <div class="eff-4"></div>
    <a href="javascript:prizeList()">당첨자 확인</a>
</div>
</div>
