...
<body>
<br><br><br><br>
<h2 align="center" style="font-size:100px;">PlannerDang</h2>
<br><br><br><br><br><br>
	<div id="loginBody">
...
<div class="form-group" id="divId">
    <div class="col-lg-10">
		<input type="text" class="form-control onlyAlphabetAndNumber" id="id" name="mem_id" placeholder="ID" maxlength="30" required="required" value="${saveid}" style="width:100%; font-size:30pt; padding:100px;">
	</div>
</div>
</td>
</tr>
...
<div class="form-group" id="divPassword">
    <div class="col-lg-10">
    	<input type="password" class="form-control" id="password" name="mem_pwd" placeholder="PASSWORD" maxlength="30" required="required" height="40px" style="width:100%; font-size:30pt; padding:100px;">
    </div>
</div>
</td>
</tr>    
...
<tr>
	<c:if test="${saveid==''}">
	<td colspan="4"><input type="checkbox" name="cb" value="on" style="-webkit-transform: scale(4); margin-left: 30px;"><font size="10" style="margin-left: 30px;">ID기억</font></td>
	</c:if>
	
	<c:if test="${saveid!=''}">
	<td colspan="4"><input type="checkbox" name="cb" value="on" checked="checked" style="-webkit-transform: scale(4); mragin-left: 30px;"><font size="10" style="margin-left: 30px;">ID기억</font></td>
	</c:if>
	...
	<td colspan="4">
	<br><br>
	<input type="submit" id="loginBtn" value="LOGIN" style="height:200px; width:100%;"><br><br><br>
	</td>
	</tr>
	</form>
