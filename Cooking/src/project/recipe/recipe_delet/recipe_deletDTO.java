...
public class recipe_deletDTO {
    ...
    public recipe_deletDTO() {
    }
    
    public recipe_deletDTO(int recipe_idx, int user_idx, String recipe_category, String recipe_title, String recipe_img,
