...
public class recipe_writeDTO {
    ...
    public recipe_writeDTO() {
	}

	public recipe_writeDTO(int recipe_idx, int user_idx, String recipe_category, String recipe_title, String recipe_img,
