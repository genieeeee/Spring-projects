...
public class recipe_modifyDTO {
    ...
    public recipe_modifyDTO() {
	}

	public recipe_modifyDTO(int recipe_idx, int user_idx, String recipe_category, String recipe_title,
			String recipe_img, String recipe_simple_comment, String recipe_material, String recipe_step,
			int recipe_time_s, int recipe_time_a, int recipe_price, String recipe_recommend) {
		super();
	...
	public recipe_modifyDTO(String recipe_category, String recipe_title, String recipe_img,
			String recipe_simple_comment, String recipe_material, String recipe_step, int recipe_time_s,
			int recipe_time_a, int recipe_price) {
		super();
		this.recipe_category = recipe_category;
		this.recipe_title = recipe_title;
		this.recipe_img = recipe_img;
