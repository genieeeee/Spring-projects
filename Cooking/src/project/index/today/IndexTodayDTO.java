...
public class IndexTodayDTO {
	...
	private int recipe_recommend_count;
	
	public IndexTodayDTO() {
	}
	
	public IndexTodayDTO(int recipe_idx, int user_idx, String recipe_category, String recipe_title, String recipe_img,
			String recipe_simple_comment, String recipe_material, String recipe_step, int recipe_time_s,
			int recipe_time_a, int recipe_price, String recipe_recommend, int recipe_recommend_count) {
		super();
		...
		this.recipe_recommend_count = recipe_recommend_count;
	}
	...
	public int getRecipe_recommend_count() {
		return recipe_recommend_count;
	}

	public void setRecipe_recommend_count(int recipe_recommend_count) {
		this.recipe_recommend_count = recipe_recommend_count;
	}
